...
const EmployerJobList = () => {
  ...
  const { employerJobs } = useSelector((state) => state.employer);
  return (
    <div>
        ...
        <div className="banner text-center">
          <div className="mx-1">
            ...
            <p id="hh" className="mt-4">
              Total{" "}
              {employerJobs && employerJobs.data ? employerJobs.data.length : 0}{" "}
              Job(s).
            </p>
          </div>
        </div>
          ...
          <div className="job-list mt-4">
            <table className="table table-borderless">
              ...
              <tbody className="tbody">
                ...
                {employerJobs &&
                  employerJobs.data &&
                  employerJobs.data.map((job, index) => (
                    <tr
          ...
          <div className="d-flex justify-content-center mt-3">
            {employerJobs &&
              ...
              employerJobs.meta && (
                <Paginate
                  data={{
                    links: employerJobs.links,
                    meta: employerJobs.meta,
                  }}
                />
              )}
          </div>
